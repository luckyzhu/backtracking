//
//  BTWebSocketViewController.m
//  BackTracking
//
//  Created by ZhuLuxi on 2020/6/21.
//  Copyright © 2020 newboy. All rights reserved.
//

#import "BTWebSocketViewController.h"
#import "WebSocketManager.h"
#import <Endian.h>

@interface BTWebSocketViewController ()<WebSocketManagerDelegate>

@property (nonatomic, strong) UITextField *textField;
//@property (nonatomic, strong) WebSocketManager *socketManager;

@end
@implementation BTWebSocketViewController
- (void)viewDidLoad {
    [super viewDidLoad];
